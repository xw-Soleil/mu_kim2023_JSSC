...
map_file=${repo_root}/flow/calibre/lefdef_6lmT1_v2.map
...
fdi_log=${repo_root}/flow/reports/openroad/50_fdi2gds_v2.log
...
# Merge the real foundry masters last so they overwrite same-name LEF
# abstracts while the routed top cell and its instance references are kept.
