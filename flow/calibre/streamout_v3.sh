...
map_file=${repo_root}/flow/calibre/lefdef_6lmT1_v3.map
...
fdi_log=${repo_root}/flow/reports/openroad/50_fdi2gds_v3.log

# The Calibre launcher consults these variables and otherwise may redirect to
# an older user-default installation even when invoked by an absolute path.
