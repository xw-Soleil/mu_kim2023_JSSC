# Clean M1-M5 power mesh.  M6 is intentionally reserved because the supplied
# LEF VIA5 geometry cannot connect the chosen mesh widths in this OpenROAD
# release; the M4/M5 ring and adjacent-layer mesh remain fully connected.
...
pdngen -failed_via_report [file join $report_dir 00_pdn_v3_failed_vias.rpt]

report_design_area
write_db [file join $work_dir 00_floorplan_pdn_v3.odb]
write_def [file join $result_dir 00_floorplan_pdn_v3.def]
