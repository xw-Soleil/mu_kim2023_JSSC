# Routability-oriented floorplan: 35% raw utilization and a clean M1-M5 PDN.
...
# M6 is free for long signal routes; the qualified core grid occupies M1-M5.
...
pdngen -failed_via_report [file join $report_dir 00_pdn_v4_failed_vias.rpt]

report_design_area
write_db [file join $work_dir 00_floorplan_pdn_v4.odb]
write_def [file join $result_dir 00_floorplan_pdn_v4.def]
