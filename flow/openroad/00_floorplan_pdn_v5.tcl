...
pdngen -failed_via_report [file join $report_dir 00_pdn_v5_failed_vias.rpt]

foreach net {VDD VSS} {
  psm::clear_solvers
  check_power_grid -net $net -floorplanning \
    -error_file [file join $report_dir 00_pdn_v5_${net}_open.rpt]
}

report_design_area
write_db [file join $work_dir 00_floorplan_pdn_v5.odb]
write_def [file join $result_dir 00_floorplan_pdn_v5.def]
puts "PDE_OPENROAD_FLOORPLAN_PDN_V5_PASS"
exit
