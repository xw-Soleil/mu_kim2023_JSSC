...
set input_db [file join $work_dir 00_floorplan_pdn_v5.odb]
...
check_placement -verbose -disallow_one_site_gaps \
  -report_file_name [file join $report_dir 10_check_placement_v3.rpt]

foreach net {VDD VSS} {
  psm::clear_solvers
  check_power_grid -net $net \
    -error_file [file join $report_dir 10_pdn_v3_${net}_open.rpt]
}

write_db [file join $work_dir 10_place_v3.odb]
write_def [file join $result_dir 10_place_v3.def]
report_design_area
puts "PDE_OPENROAD_PLACE_V3_PASS"
exit
