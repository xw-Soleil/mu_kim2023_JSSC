# CTS using only the pin-access-qualified BUFFD2 master.  The prior CKBD8
# choice creates two unroutable unique access patterns in this TSMC65 LEF.
...
set input_db [file join $work_dir 10_place_v4.odb]
...
detailed_placement -max_displacement {30 10} -disallow_one_site_gaps \
  -report_file_name [file join $report_dir 20_cts_buffd2_v10_placement.json]
global_connect
...
foreach net {VDD VSS} {
  ...
  check_power_grid -net $net \
    -error_file [file join $report_dir 20_cts_buffd2_v10_${net}_open.rpt]
}

write_db [file join $work_dir 20_cts_buffd2_v10.odb]
write_def [file join $result_dir 20_cts_buffd2_v10.def]
write_verilog -include_pwr_gnd [file join $result_dir 20_cts_buffd2_v10.v]
write_sdc -no_timestamp [file join $result_dir 20_cts_buffd2_v10.sdc]
report_cts -out_file [file join $report_dir 20_cts_buffd2_v10.rpt]
puts "PDE_OPENROAD_CTS_BUFFD2_V10_PASS"
exit
