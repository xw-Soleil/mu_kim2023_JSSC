...
detailed_placement -max_displacement {30 10} -disallow_one_site_gaps \
  -report_file_name [file join $report_dir 20_cts_buffd2_v11_placement.json]
global_connect
...
foreach net {VDD VSS} {
  ...
  check_power_grid -net $net \
    -error_file [file join $report_dir 20_cts_buffd2_v11_${net}_open.rpt]
}

write_db [file join $work_dir 20_cts_buffd2_v11.odb]
write_def [file join $result_dir 20_cts_buffd2_v11.def]
write_verilog -include_pwr_gnd [file join $result_dir 20_cts_buffd2_v11.v]
write_sdc -no_timestamp [file join $result_dir 20_cts_buffd2_v11.sdc]
report_cts -out_file [file join $report_dir 20_cts_buffd2_v11.rpt]
puts "PDE_OPENROAD_CTS_BUFFD2_V11_PASS"
exit
