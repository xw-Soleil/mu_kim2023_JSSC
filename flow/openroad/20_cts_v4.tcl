...
foreach net {VDD VSS} {
  ...
  check_power_grid -net $net \
    -error_file [file join $report_dir 20_pdn_v4_${net}_open.rpt]
}

write_db [file join $work_dir 20_cts_v4.odb]
write_def [file join $result_dir 20_cts_v4.def]
write_verilog -include_pwr_gnd [file join $result_dir 20_cts_v4.v]
write_sdc -no_timestamp [file join $result_dir 20_cts_v4.sdc]
report_cts -out_file [file join $report_dir 20_cts_v4.rpt]
puts "PDE_OPENROAD_CTS_V4_PASS"
exit
