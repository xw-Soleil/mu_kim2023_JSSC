# Re-map every CKBD8 to the pin-compatible CKBD4 equivalent available in both
# the TSMC65 LEF and implementation Liberty, then legalize and hard-gate pin
# access.  The 3537 count includes 3169 CTS cells and 368 synthesized cells.
...
puts "PDE_ALL_CKBD8_TO_CKBD4_SWAPPED=$swapped"
...
detailed_placement -max_displacement {30 10} -disallow_one_site_gaps \
  -report_file_name [file join $report_dir 21_ckbd4_v8_placement.json]
global_connect
...
foreach net {VDD VSS} {
  ...
  check_power_grid -net $net \
    -error_file [file join $report_dir 21_ckbd4_v8_${net}_open.rpt]
}

estimate_parasitics -placement
report_checks -path_delay max -fields {slew cap input_pins nets fanout} \
  > [file join $report_dir 21_ckbd4_v8_timing.rpt]
report_design_area
write_db [file join $work_dir 21_cts_ckbd4_pinaccess_v8.odb]
write_def [file join $result_dir 21_cts_ckbd4_pinaccess_v8.def]
write_sdc -no_timestamp [file join $result_dir 21_cts_ckbd4_pinaccess_v8.sdc]
puts "PDE_CTS_CKBD4_PINACCESS_V8_PASS"
exit
