# Parameterized congestion-tolerant global route for the pin-access-qualified BUFFD2 CTS DB.
# Required environment: PDE_GRT_TAG and PDE_GRT_SEED.
...
set sdc [file join $repo_root flow results openroad 20_cts_buffd2_v11.sdc]
...
puts "PDE_GRT_GUIDE_PASS tag=$tag seed=$seed"
exit
