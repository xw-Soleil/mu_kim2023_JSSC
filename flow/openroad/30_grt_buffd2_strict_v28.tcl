...
# v28: v27 congested with only overflow:1 hotspots (~65 gcells near x 306-324um);
# release ~7% more lower-layer capacity instead of touching placement.
#
...
# Required environment: PDE_GRT_TAG (grt_buffd2_strict_s<N>_v28) and
# PDE_GRT_SEED.
...
set_global_routing_layer_adjustment M2 0.45
set_global_routing_layer_adjustment M3 0.35
set_global_routing_layer_adjustment M4 0.12
set_global_routing_layer_adjustment M5 0.12
