# Strict global route using nominal routing capacity.  The 90% trial still had
...
foreach net {VDD VSS} {
  ...
  check_power_grid -net $net \
    -error_file [file join $report_dir 30_pdn_v11_pregrt_${net}_open.rpt]
}
...
global_route -guide_file [file join $result_dir 30_route_antenna_v11.guide] \
  -congestion_iterations 50 -congestion_report_iter_step 10 \
  -critical_nets_percentage 0 \
  -congestion_report_file [file join $report_dir 30_congestion_v11.rpt]
...
write_db [file join $work_dir 35_antenna_v11.odb]
write_def [file join $result_dir 35_antenna_v11.def]
write_sdc -no_timestamp [file join $result_dir 35_antenna_v11.sdc]
write_guides [file join $result_dir 35_antenna_v11_postrepair.guide]

set antenna_violations [check_antennas \
  -report_file [file join $report_dir 35_antenna_v11.rpt]]
...
foreach net {VDD VSS} {
  psm::clear_solvers
  check_power_grid -net $net \
    -error_file [file join $report_dir 35_pdn_v11_${net}_open.rpt]
}

puts "PDE_OPENROAD_ROUTE_ANTENNA_V11_PASS"
exit
