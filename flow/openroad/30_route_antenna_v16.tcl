# Strict global route using nominal routing capacity and deterministic net-order seed 3.  The 90% trial still had
...
foreach net {VDD VSS} {
  ...
  check_power_grid -net $net \
    -error_file [file join $report_dir 30_pdn_v16_pregrt_${net}_open.rpt]
}
...
set_global_routing_random -seed 3

global_route -guide_file [file join $result_dir 30_route_antenna_v16.guide] \
  -congestion_iterations 100 -congestion_report_iter_step 10 \
  -critical_nets_percentage 0 \
  -congestion_report_file [file join $report_dir 30_congestion_v16.rpt]
...
write_db [file join $work_dir 35_antenna_v16.odb]
write_def [file join $result_dir 35_antenna_v16.def]
write_sdc -no_timestamp [file join $result_dir 35_antenna_v16.sdc]
write_guides [file join $result_dir 35_antenna_v16_postrepair.guide]

set antenna_violations [check_antennas \
  -report_file [file join $report_dir 35_antenna_v16.rpt]]
...
foreach net {VDD VSS} {
  psm::clear_solvers
  check_power_grid -net $net \
    -error_file [file join $report_dir 35_pdn_v16_${net}_open.rpt]
}

puts "PDE_OPENROAD_ROUTE_ANTENNA_V16_PASS"
exit
