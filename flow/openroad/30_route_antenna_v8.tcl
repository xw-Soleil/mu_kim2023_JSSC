# Global routing and pre-DRT antenna closure on connected CTS/PDN state.
...
global_route -guide_file [file join $result_dir 30_route_antenna_v8.guide] \
  -congestion_iterations 100 -congestion_report_iter_step 10 \
  -critical_nets_percentage 0 -allow_congestion \
  -congestion_report_file [file join $report_dir 30_congestion_v8.rpt]

repair_antennas ANTENNA -iterations 3 -ratio_margin 20
global_connect
assert_all_pg_iterms_connected ANTENNA
check_placement -verbose
estimate_parasitics -global_routing

write_db [file join $work_dir 35_antenna_v8.odb]
write_def [file join $result_dir 35_antenna_v8.def]
write_sdc -no_timestamp [file join $result_dir 35_antenna_v8.sdc]

set antenna_violations [check_antennas \
  -report_file [file join $report_dir 35_antenna_v8.rpt]]
...
foreach net {VDD VSS} {
  ...
  check_power_grid -net $net \
    -error_file [file join $report_dir 35_pdn_v8_${net}_open.rpt]
}

puts "PDE_OPENROAD_ROUTE_ANTENNA_V8_PASS"
exit
