...
if {![regexp {^grt_buffd2_strict_s([1-3])_v28$} $input_tag -> guide_seed]} {
  error "Unsafe or unsupported PDE_DRT_INPUT_TAG: $input_tag"
}
if {![regexp {^drt_buffd2_s([1-3])_v30$} $tag -> route_seed]} {
...
set sdc [file join $result_dir 20_cts_buffd2_v12.sdc]
