# Detailed route from v15 nominal-capacity seed-2 strict GRT, with bounded post-route antenna closure.
...
set input_db [file join $work_dir 35_antenna_v15.odb]
set sdc [file join $repo_root flow results openroad 35_antenna_v15.sdc]
...
run_drt initial_v17 $report_dir
set antenna_violations [check_antennas \
  -report_file [file join $report_dir 40_v17_initial_antennas.rpt]]
...
while {$antenna_violations > 0 && $antenna_round < 3} {
  ...
  run_drt v17_postant_${antenna_round} $report_dir
  set antenna_violations [check_antennas \
    -report_file [file join $report_dir 40_v17_postant_${antenna_round}.rpt]]
...
foreach net {VDD VSS} {
  ...
  check_power_grid -net $net \
    -error_file [file join $report_dir 40_pdn_v17_prefill_${net}_open.rpt]
}

write_db [file join $work_dir 40_route_v17_prefill_antclosed.odb]
write_def -version 5.8 [file join $result_dir 40_route_v17_prefill_antclosed.def]
