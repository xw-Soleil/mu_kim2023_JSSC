# Detailed route from v18 30-percent-utilization strict GRT, with bounded post-route antenna closure.
...
set input_db [file join $work_dir 35_antenna_v18.odb]
set sdc [file join $repo_root flow results openroad 35_antenna_v18.sdc]
...
run_drt initial_v19 $report_dir
set antenna_violations [check_antennas \
  -report_file [file join $report_dir 40_v19_initial_antennas.rpt]]
...
while {$antenna_violations > 0 && $antenna_round < 3} {
  ...
  run_drt v19_postant_${antenna_round} $report_dir
  set antenna_violations [check_antennas \
    -report_file [file join $report_dir 40_v19_postant_${antenna_round}.rpt]]
...
foreach net {VDD VSS} {
  ...
  check_power_grid -net $net \
    -error_file [file join $report_dir 40_pdn_v19_prefill_${net}_open.rpt]
}

write_db [file join $work_dir 40_route_v19_prefill_antclosed.odb]
write_def -version 5.8 [file join $result_dir 40_route_v19_prefill_antclosed.def]
