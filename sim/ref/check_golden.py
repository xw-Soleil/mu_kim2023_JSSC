...
behavioural model.
    ...
    python3 rtl/sim/check_golden.py rtl/sim/u_dyn.txt <nrow> <ncol> <boundary|mixed>
...
rtl/reference/golden_model.py reproduces the exact integer arithmetic, so the two
